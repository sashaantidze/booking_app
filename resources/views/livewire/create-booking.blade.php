        ...
        <div class="bg-white rounded-lg">
            ...
            <div class="flex justify-between items-center px-3 border-b border-gray-200 pb-2">
                <button type="button" class="text-center group cursor-pointer focus:outline-none">
                    ...
                    <div class="text-xs leading-none mb-2 text-gray-700">Mon</div>

                    <div class="text-lg leading-none p-1 rounded-full w-9 h-9 flex items-center justify-center group-hover:bg-gray-200">1</div>
